    ...
    numClocks(1)
{
    ...
    output.init("CaptCrunch[" + getName() + ":@p:@t]: ", Verbosity, 0, SST::Output::STDOUT);
    output.verbose(CALL_INFO, 5, 0, "Init is complete\n");
    clockHandler  = new SST::Clock::Handler2<CaptCrunch, &CaptCrunch::clockTick>(this);
...
void
CaptCrunch::init(unsigned int phase)
{}

void
CaptCrunch::serialize_order(SST::Core::Serialization::serializer& ser)
{
...
bool
CaptCrunch::clockTick(SST::Cycle_t currentCycle)
{
