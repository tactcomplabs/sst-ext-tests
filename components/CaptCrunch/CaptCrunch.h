...
ImplementSerializable(SST::CaptCrunch::CaptCrunch)
  ...
  std::unordered_set<struct __fundamentalTypeStruct,
                     __fundamentalTypeStruct::Hash>
      structUnSet;
  ...
  std::unordered_multiset<struct __fundamentalTypeStruct,
                          __fundamentalTypeStruct::Hash>
      structUnMSet;

  std::unordered_multimap<unsigned, unsigned> unsignedUnMMap;
  std::unordered_multimap<char, unsigned> charUnMMap;
  std::unordered_multimap<unsigned, struct __fundamentalTypeStruct>
      structUnMMap;
