...
export TERM=linux
export CC=/pkgs/Linux/Ubuntu-22.04/LLVM/LLVM-20.1.0-Linux-X64/bin/clang
export CXX=/pkgs/Linux/Ubuntu-22.04/LLVM/LLVM-20.1.0-Linux-X64/bin/clang++
export SST_INSTALL=/jenkins/sst-clang20-openmpi4.1.2-$BRANCH
rm -Rf $SST_INSTALL/*
