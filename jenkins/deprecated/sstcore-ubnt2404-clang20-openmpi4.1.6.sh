...
export TERM=linux
export CC=/pkgs/Linux/Ubuntu-24.04/LLVM/LLVM-20.1.0-Linux-X64/bin/clang
export CXX=/pkgs/Linux/Ubuntu-24.04/LLVM/LLVM-20.1.0-Linux-X64/bin/clang++
export SST_INSTALL=/jenkins/sst-clang20-openmpi4.1.6-$BRANCH
rm -Rf $SST_INSTALL/*
if [ "$CLANGFORMAT" = true ]; then
	./scripts/clang-format-test.sh --format-exe /pkgs/Linux/Ubuntu-24.04/LLVM/LLVM-20.1.0-Linux-X64/bin/clang-format
fi
./autogen.sh
if [ "$DEBUG" = true ]; then
