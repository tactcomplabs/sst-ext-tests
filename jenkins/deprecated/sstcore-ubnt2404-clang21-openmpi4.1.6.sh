...
export TERM=linux
export CC=/pkgs/Linux/Ubuntu-24.04/LLVM/LLVM-21.1.4-Linux-X64/bin/clang
export CXX=/pkgs/Linux/Ubuntu-24.04/LLVM/LLVM-21.1.4-Linux-X64/bin/clang++
export SST_INSTALL=/jenkins/sst-clang21-openmpi4.1.6-$BRANCH
rm -Rf $SST_INSTALL/*
if [ "$CLANGFORMAT" = true ]; then
	./scripts/clang-format-test.sh --format-exe /pkgs/Linux/Ubuntu-24.04/LLVM/LLVM-21.1.4-Linux-X64/bin/clang-format
fi
./autogen.sh
if [ "$DEBUG" = true ]; then
