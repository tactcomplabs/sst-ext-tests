...
LAUNCH="sst --interactive-console=sst.interactive.simpledebug --interactive-start=0s --add-lib-path=$SST_COMPONENT_BASE/tests/components/CaptCrunchObjMap/ CaptCrunchObjMap.py"
