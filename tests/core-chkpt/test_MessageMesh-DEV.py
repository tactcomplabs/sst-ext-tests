...
#EXT_TEST TEST_FILE_DESC "Tests message mesh routing with checkpointing"
#EXT_TEST DEP "coreTestElement.message_mesh.message_port coreTestElement.message_mesh.port_slot coreTestElement.message_mesh.route_message"
import sst
import sys
...
x_size = 4 #int(sys.argv[1])
y_size = 4 #int(sys.argv[2])
