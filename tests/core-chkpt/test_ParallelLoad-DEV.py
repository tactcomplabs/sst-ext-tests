...
#EXT_TEST TEST_FILE_DESC "Tests parallel loading with checkpointing"
#EXT_TEST DEP "coreTestElement.message_mesh.enclosing_component coreTestElement.message_mesh.route_message coreTestElement.message_mesh.message_port"
import sst
import sys
