...
#EXT_TEST TEST_FILE_DESC "Tests subcomponent loading with checkpointing"
#EXT_TEST DEP "coreTestElement.SubComponentLoader coreTestElement.SubCompSender coreTestElement.SubCompReceiver"
import sst
