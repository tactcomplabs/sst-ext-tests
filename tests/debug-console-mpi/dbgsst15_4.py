...
cp2 = sst.Component("cp2", "dbgsst15.DbgSST15")
cp2.addParams({
  "verbose" : args.verbose,
  "numPorts" : 1,
  "minData" : MIN_DATA,
...
cp3 = sst.Component("cp3", "dbgsst15.DbgSST15")
cp3.addParams({
  "verbose" : args.verbose,
  "numPorts" : 1,
  "minData" : MIN_DATA,
...
link0.connect( (cp0, "port0", "1us"), (cp3, "port0", "1us") )
link1 = sst.Link("link1")
link1.connect( (cp1, "port0", "1us"), (cp2, "port0", "1us") )
