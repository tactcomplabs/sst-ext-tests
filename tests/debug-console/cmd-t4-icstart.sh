...
#EXT_TEST TEST_FILE_DESC "Test delayed interactive start (1ms) with multiple threads"
#EXT_TEST TIMEOUT 30
...
LAUNCH="sst -n $THREADS --interactive-start=1ms --add-lib-path=$SST_COMPONENT_BASE/core-debug $CONFIG -- --verbose=0"
echo $LAUNCH
revVal=0
